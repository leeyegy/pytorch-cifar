...
# save_path = os.path.join("../checkpoint","mnist","amart_"+args.net,"beta_"+str(args.beta)+"_gamma_"+str(args.gamma))
# exp_name = os.path.join("../runs", "mnist","amart_"+args.net,"beta_"+str(args.beta)+"_gamma_"+str(args.gamma))
save_path = os.path.join("../checkpoint","mnist","amart_"+args.net,"beta_"+str(args.beta)+"_change_gamma_100")
exp_name = os.path.join("../runs", "mnist","amart_"+args.net,"beta_"+str(args.beta)+"_change_gamma_100")
