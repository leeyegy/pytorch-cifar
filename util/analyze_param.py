...
if __name__ == "__main__":
    ...
    naturally_trained_res18.load_state_dict(torch.load("../checkpoint/CS_ResNet18/ckpt.pth")['net'])

    Madry_trained_res18 = ResNet18().cuda()
    Madry_trained_res18 = torch.nn.DataParallel(Madry_trained_res18)
    Madry_trained_res18.load_state_dict(torch.load("../checkpoint/CS_ResNet18/Madry_trained.pth")['net'])
