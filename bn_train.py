...
save_path = os.path.join("checkpoint","bn_"+args.net,"mart_beta_"+str(args.beta))
exp_name = os.path.join("runs", "bn_"+args.net,"mart_beta_"+str(args.beta))
...
print("best clean acc: {}".format(best_acc))
