...
save_path = os.path.join("checkpoint","bn_"+args.net,str(args.epoch_nb)+"_trades_beta_"+str(args.beta)) if not args.random_bn else os.path.join("checkpoint","random_bn_"+args.net,str(args.epoch_nb)+"_trades_beta_"+str(args.beta))
exp_name = os.path.join("runs", "bn_"+args.net,str(args.epoch_nb)+"_trades_beta_"+str(args.beta)) if not args.random_bn else os.path.join("runs", "random_bn_"+args.net,str(args.epoch_nb)+"_trades_beta_"+str(args.beta))
...
print("best clean acc: {}".format(checkpoint['acc']))
