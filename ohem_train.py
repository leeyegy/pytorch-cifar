...
save_path = os.path.join("checkpoint","ohem_"+args.net,args.loss+"_beta_"+str(args.beta)+"_ratio_"+str(args.ratio))
exp_name = os.path.join("runs", "ohem_"+args.loss+"_"+args.net,args.loss+"_beta_"+str(args.beta)+"_ratio_"+str(args.ratio))
...
# loss dict
loss_dict = {"mart":mart_ohem_loss,
             "mart-topk":mart_topk_loss,
             }
...
def train(args, model, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        loss,prev_data,prev_target = criterion(model=model,
                           x_natural=data,
                           y=target,
                           previous_batch_data=prev_data,
                           previous_batch_target=prev_target,
                           optimizer=optimizer,
                           ratio=args.ratio,
