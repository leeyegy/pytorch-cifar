...
assert 0<= args.emphasize_label <= 9
...
save_path = os.path.join("checkpoint","emphasize_mart_"+args.net,"beta_"+str(args.beta),"emphasize_"+str(args.emphasize_label))
exp_name = os.path.join("runs", "emphasize_mart_"+args.net,"beta_"+str(args.beta),"emphasize_"+str(args.emphasize_label))
...
print("init resumed")
checkpoint = torch.load(args.resume_init)
net.load_state_dict(checkpoint['net'])
init_acc = checkpoint['acc']
init_start_epoch = checkpoint['epoch']
print("init robust acc:{}".format(init_acc))
